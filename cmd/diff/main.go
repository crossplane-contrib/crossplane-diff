...
type CommonCmdFields struct {
	...
	FunctionCredentials string        `help:"A YAML file or directory of YAML files specifying Secret credentials to pass to Functions." name:"function-credentials"                   placeholder:"PATH"      type:"path"`
}
