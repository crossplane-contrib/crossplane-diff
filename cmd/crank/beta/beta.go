...
import (
	"github.com/crossplane-contrib/crossplane-diff/cmd/crank/beta/diff"
)
...
type Cmd struct {
	...
	Diff diff.Cmd `cmd:"" help:"See what changes will be made against a live cluster when a given Crossplane resource would be applied."`
}
